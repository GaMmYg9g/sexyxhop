...
async function showProduct(productId) {
    ...
    try {
        const response = await fetch(API_URL + 'get-reviews.php?id=' + productId);
...
async function submitReview(productId) {
    ...
    try {
        const response = await fetch(API_URL + 'add-review.php', {
            method: 'POST',
...
async function confirmOrder() {
    ...
    try {
        ...
        const response = await fetch(API_URL + 'create-order.php', {
            method: 'POST',
            headers: {'Content-Type': 'application/json'},
